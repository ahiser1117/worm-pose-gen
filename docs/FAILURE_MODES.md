...
| Spatial-bottleneck regression to mean | Centroid/length distributions and fully-visible overlays | Prospectively test a higher-resolution encoder bottleneck | EXP-0004 intrinsic best still 116.92 px median and 23.35 deg mean angle; family rejected |
